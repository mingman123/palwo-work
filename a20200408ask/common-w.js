init_ZMApp({
	...
	'img': 'https://game.gtimg.cn/images/lol/act/a20200408ask/share.jpg',
...
$(".tc-reply .close").click(function(){
	$(".tc-fc").hide();
	$(".tc-reply").hide();
})
$(".same .question").click(function(){
	console.log(11);
	if ($(this).children(".txt").hasClass("on")) {
...
var num = 0;
    var t = setInterval(function(){
       num++;
       var span1 = document.getElementById("num");
       span1.innerText = num;
	        if(num==100){
	        	clearInterval(t);
	        	setTimeout(function(){
