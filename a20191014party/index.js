...
var docW = document.documentElement.clientWidth / 688;
var docW2 = document.documentElement.clientWidth / 700;
var arr = [
	[10,10],
	[128,10],
	[246,10],
...
//      "10_10,128_10,246_10,364_10,478_10,478_128,478_246,364_246,246_246,128_246,10_246,10_128,",
var str = '';
for(var i = 0; i< arr.length; i++) {	
	var _str = Math.round(arr[i][0]*docW2) + '_' + Math.round(arr[i][1]*docW2) + ',';
	str = str + _str;
}
console.log(str);
    //初始化抽奖的 可以不知道内部
    var lottery = new Lottery({
        'lighturl': 'ossweb-img/lotteryon.png',//外部光圈png 不填写就用默认的效果
        'starturl': 'ossweb-img/btn.gif', //外部按钮png 不填写就用默认的按钮效果
        'width': 648*docW,//lottery 宽度
        'height': 404*docW,//lottery 高度
        'total': 12,//抽奖产品的总数
        'sbtnx': 144*docW,// 开始抽奖按钮的位置x坐标
        'sbtny': 132*docW,// 开始抽奖按钮的位置y坐标
        'sbtnw': 318*docW,// 开始抽奖按钮的宽度
        'sbtnh': 108*docW,// 开始抽奖按钮的高度
        'boxw': 118*docW,// 奖品光效的宽度
        'boxh': 118*docW,//奖品光效的高度 
        'position': str,
