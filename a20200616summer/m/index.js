...
//	})
	...
	var imgArr = ['../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', '../ossweb-img/m/img1.png', ]

	$(".dia5 .card-com li.on").click(function() {
		var idx = $(this).index();
		//		console.log(idx)
		$(".dia10 img").attr("src", imgArr[idx]);
		TGDialogS("dia10");
