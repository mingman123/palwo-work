$('.tabbox a').on('click', function() {
	...
	if(idx != 0) {
		$('.wrapbg-box i').css({
			"background": "url(//game.gtimg.cn/images/lol/act/a20201019strategy/hero/mc-hero3.png) no-repeat",
		...
		$('.wrapbg-box i').css({
			"background": "url(//game.gtimg.cn/images/lol/act/a20201019strategy/hero/bg-mc-img.png) no-repeat",
			"background-size": "100% auto"
		});
		$('.wrapbg-box img').css({
			"filter": "blur(0px)"
