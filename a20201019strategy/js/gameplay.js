...
//  console.log(idx);
	...
	if(idx != 1){
    	 $('.wrap').css({"background":"url(ossweb-img/gameplay/bg.jpg) no-repeat left top","background-size":"100% auto"});
    }else{
    	$('.wrap').css({"background":"url(ossweb-img/gameplay/bg2.jpg) no-repeat left top","background-size":"100% auto"});
    }
})
